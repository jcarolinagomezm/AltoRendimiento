...
* Clase Otime: Clase en c, para capturar y guardar los tiempos de ejecución de los procesos openmp, que seran usados para calcular el speedUp
*************************************************************************/

// Inclusión de bibliotecas o librerias
